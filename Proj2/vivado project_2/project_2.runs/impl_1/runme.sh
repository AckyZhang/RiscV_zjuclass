...
HD_PWD='E:/proj/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32Core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32Core.tcl -notrace
